...
async def blefaroplastia(request: Request):
    """
    Endpoint para procesar un modelo .glb, modificarlo con múltiples transformaciones,
    ...
    try:
        ...
        # Modificar vértices con múltiples parámetros
        ...
        for i in range(accessor.count):
            ...
            # Transformaciones específicas de blefaroplastia
            x += 0.005  # Desplazamiento en X
            y *= 1.015  # Escalado en Y
            z -= 3.0    # Reducción en Z
            if i % 2 == 0:  # Condicional para algunos vértices
                x *= 0.98
                y -= 0.002
            else:
                z += 1.5
