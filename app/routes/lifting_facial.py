...
@router.post("/lifting_facial")
async def lifting_facial(request: Request):
    """
    ...
    try:
        ...
        # Subir a Cloudinary en la carpeta 'lifting_facial' con un nombre único
        print("Subiendo el archivo a Cloudinary...")
        upload_response = cloudinary.uploader.upload(
            output_file,
            resource_type="raw",
            folder="lifting_facial",
            public_id=f"lifting_facial/{unique_filename}"
        )
